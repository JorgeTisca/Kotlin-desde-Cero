fun main(args: Array<String>) {
    ...
    val mensajeInmutable =
            if (nombre.length > 8) "Tienes un nombre largo!" else "Tienes un nombre corto"
    println(mensajeInmutable)

    // Asignación de variable inmutable con else if
    val mensajeInmutable2 =
            if (nombre.length > 8) "Tienes un nombre largo!"
            else if (nombre.isEmpty()) "Este nombre esta vacio :(" else "Tienes un nombre corto"
